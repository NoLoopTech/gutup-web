            ...
            <div className="text-black space-y-4">
                <div className="flex justify-end items-start" style={{ marginTop: "-4.4rem" }}>
                    <div className="w-80" style={{ width: "25.2rem" }}>
                        <Label className="text-black mb-1 block">Shop Name</Label>
                ...
                <Label className="text-gray-500 block">Cant find the ingredient you want? Please add the food item first to select the ingredient</Label>
                <CustomTable
                ...
                {/* Image Uploader */}
                <div className="w-full sm:w-2/5 pb-8">
