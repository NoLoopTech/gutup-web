...
export default function VideoTipTab({
  ...
  function onSubmit(data: z.infer<typeof FormSchema>): void {
    buildConcernsObjects() // ensures pairing ready for parent payload builder
    addDailyTip()
  }
    ...
    <div className="relative">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          {/* Hide Video Toggle - only show when video link has a value */}
          ...
          {/* Button Label and Search Button Navigation */}
