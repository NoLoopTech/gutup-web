...
export default function AddMoodPopUp({
  ...
  return (
    <div>
      ...
      <div>
        {activeTab === "Quote" && (
          <QuoteTab translations={translations} onClose={onClose} />
        )}
        {activeTab === "Food" && (
          <FoodTab translations={translations} onClose={onClose} />
        )}
        {activeTab === "Recipe" && (
          <RecipeTab translations={translations} onClose={onClose} />
        )}
      </div>
    </div>
  )
